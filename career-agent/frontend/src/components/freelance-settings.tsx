  ...
  return (
    <div className="relative min-h-dvh overflow-x-hidden bg-surface-0 text-slate-100 pb-20">
      ...
      <main className="relative z-10 mx-auto max-w-4xl px-4 py-8 sm:px-6">
        ...
        {saved && (
          <div className="mb-6 rounded-surface border border-amber-500/30 bg-amber-950/40 p-4 text-xs text-amber-300">
        ...
        <form onSubmit={submit} className="space-y-6">
          <div className="glass-panel rounded-surface p-6 border border-line-strong space-y-5">
            <div>
              ...
              <input
                ...
                className="h-11 w-full rounded-control border border-line-strong bg-surface-1 px-3.5 text-xs text-white placeholder:text-slate-500 focus:border-amber-500/50 focus:outline-none"
              />
              <span className="mt-1 block text-xs text-slate-500">Drives which public gigs and feeds are admitted by the pre-filter.</span>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="h-11 w-full rounded-control border border-line-strong bg-surface-1 px-3.5 text-xs text-white placeholder:text-slate-500 focus:border-amber-500/50 focus:outline-none"
              />
              <span className="mt-1 block text-xs text-slate-500">Allows Gemini to evaluate client timeline feasibility.</span>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-y rounded-control border border-line-strong bg-surface-1 p-3 text-xs leading-relaxed text-slate-200 placeholder:text-slate-500 focus:border-amber-500/50 focus:outline-none"
              />
              <span className="mt-1 block text-xs text-slate-500">The freelance evaluator checks client requirements against this service list.</span>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-y rounded-control border border-line-strong bg-surface-1 p-3 text-xs leading-relaxed text-slate-200 placeholder:text-slate-500 focus:border-amber-500/50 focus:outline-none"
              />
              <span className="mt-1 block text-xs text-slate-500">The pitcher agent incorporates this track record into direct client outreach messages.</span>
            </div>
          </div>
        </form>
      </main>
